...
def compute_new_price(buy_price,current_price,q_last_qarder , q_current_qarder ,coef_up,coef_down, coef_max, round=True):
    ...
    if new_price > (coef_max x * buy_price):                            # check for avoid too many growth in the price
